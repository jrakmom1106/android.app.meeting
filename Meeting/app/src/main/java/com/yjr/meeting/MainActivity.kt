...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tabLayout.getTabAt(2)?.setIcon(R.drawable.baseline_add_black_48)
        tabLayout.getTabAt(3)?.setIcon(R.drawable.baseline_star_outline_black_48)
        tabLayout.getTabAt(4)?.setIcon(R.drawable.baseline_perm_identity_black_48)
    }
